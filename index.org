...
* About me
  *梶山 隼(Hayato KAJIYANA)*
  東京都に住んでいます。
  東京工科大学大学院というところでコンピュータサイエンス修士号を取得しています。専攻はHCIでした。
  今はソフトバンク株式会社というところで社内システム(主に在庫管理)の開発を行っています。
...
** Hackernews on Emacs Dashboard (2018)
   #+attr_html: :width 100% :height 200px :style object-fit: cover;
...
** 入れ替えても読めちゃうBot (2013)
   ...
   *使用技術:*
   Java, 形態素解析(MeCab), GAE(GoogleApp Engine :width 100% :height 200px 
