...
#+HTML_HEAD: <meta name="description" content="ソフトウェアエンジニアとして働く、梶山 隼 (Hayato KAJIYAMA) のポートフォリオサイト">
...
* About me
  *梶山 隼 (Hayato KAJIYAMA)*
  ソフトバンク株式会社で社内システムの開発を行っています。
  東京工科大学大学院にてコンピュータサイエンス修士号を取得しています→[[SHAPIO: Shape I/O Controller for Video Games (2015)][研究テーマ]]
  その時その時に興味のあることに集中して取り組むのが好きです。
